...
public class UserResponseDTO {
	...
	public UserResponseDTO(int userId, String username, String email, String firstName, String lastName, UserRole role,
			UserStatus status, HolderType holderType, LocalDateTime createdAt) {
		this.userId = userId;
