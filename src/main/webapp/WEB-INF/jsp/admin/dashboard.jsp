...
<body>
	...
	<div class="container">
		...
		<p>
			Your Role:
			<%=loggedInUser.getRole() != null ? loggedInUser.getRole().name() : "N/A"%>,
			Status:
			<%=loggedInUser.getStatus() != null ? loggedInUser.getStatus().name() : "N/A"%>,
			Holder Type:
			<%=loggedInUser.getHolderType() != null ? loggedInUser.getHolderType().name() : "N/A"%>
		</p>
		<p>
		...
		<table>
			...
			<tbody>
				...
				<tr>
					...
					<td><a
						href="${pageContext.request.contextPath}/app/accounts/view?id=<%= account.getAccountId() %>">View</a>
						<%
		...
		<form
			...
			method="post">
			<h4>Deposit</h4>
			<label for="depositAccountId">Account ID:</label> <input
				type="number" id="depositAccountId" name="accountId" required><br>
			<br> <label for="depositAmount">Amount:</label> <input
		...
		<form
			...
			method="post">
			<h4>Withdrawal</h4>
			<label for="withdrawAccountId">Account ID:</label> <input
				type="number" id="withdrawAccountId" name="accountId" required><br>
			<br> <label for="withdrawAmount">Amount:</label> <input
		...
		<form
			...
			method="post">
			<h4>Transfer</h4>
			<label for="sourceAccountId">Source Account ID:</label> <input
				type="number" id="sourceAccountId" name="sourceAccountId" required><br>
			<br> <label for="targetAccountId">Target Account ID:</label> <input
				type="number" id="targetAccountId" name="targetAccountId" required><br>
			<br> <label for="transferAmount">Amount:</label> <input
		...
		<p>
			You are not logged in. Please <a
				href="${pageContext.request.contextPath}/index.jsp">login</a>.
		</p>
		<%
		}
		%>
