...
<body>
	<div class="main-content">
		...
		<p>
			Hello,
			<%=((User) session.getAttribute("loggedInUser")).getFirstName()%>!
		</p>
		<p>Your account is currently under review by our staff. You will
			receive an email notification once your account has been approved.</p>
